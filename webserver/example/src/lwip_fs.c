...
const static char http_index_html[] =
	...
	"var inputTxt = \"Welcome to our el double you aye pee aych tee tee pee server. This is a small test page, served by aych tee tee pee dee of el doubleyou aye pee.\";\n"
